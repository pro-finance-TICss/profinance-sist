...
export function Sidebar({ activeItem, setActiveItem }: SidebarProps) {
    ...
    return (
        <aside style={{
            width: '260px', height: '100vh', backgroundColor: '#000',
            ...
            <div style={{ marginBottom: '50px', padding: '0 20px' }}>
                ...
                <h1 style={{ position: 'absolute', opacity: 0, pointerEvents: 'none' }}>PRO-FINANCE</h1>
            </div>
            ...
            <nav style={{ flex: 1 }}>
                <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                    {menuItems.map((item, index) => {
                        ...
                        return (
                            <li key={index} style={{ marginBottom: '8px', padding: '0 15px' }}>
                                <button
            ...
            <div style={{ padding: '0 15px' }}>
                <button style={{
                    display: 'flex', alignItems: 'center', gap: '15px',
                    width: '100%', padding: '12px 20px', backgroundColor: 'transparent',
                    border: 'none', color: '#ff4d4d', cursor: 'pointer', borderRadius: '12px',
                    transition: 'all 0.3s'
                }}
